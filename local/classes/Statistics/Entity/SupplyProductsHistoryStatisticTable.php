...
class SupplyProductsHistoryStatisticTable extends DataManager
{
    ...
    {
        return 'trd_supply_products_statistic_history';
    }
    ...
    public static function getMap()
    {
        return [
            ...
            new Fields\BooleanField(
                'HAS_ENGINEER',
                [
                    'title' => Loc::getMessage('SP_STATISTIC_JOURNAL_ENTITY_HAS_ENGINEER_FIELD'),
                    'default' => false,
                ]
            ),
            ...
            new Fields\BooleanField(
                'IS_INACTIVE',
                [
                    'title' => Loc::getMessage('SP_STATISTIC_JOURNAL_ENTITY_IS_INACTIVE_FIELD'),
                    'default' => false,
                ]
            ),
            ...
            new Fields\BooleanField(
                'IS_FROZEN',
                [
                    'title' => Loc::getMessage('SP_STATISTIC_JOURNAL_ENTITY_IS_FROZEN_FIELD'),
                    'default' => false,
                ]
            ),
